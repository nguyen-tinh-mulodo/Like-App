#!/bin/sh
set -e
xctool -project LikeApp/LikeApp.xcodeproj -scheme TestTravis -sdk iphonesimulator  build
xctool -project LikeApp/LikeApp.xcodeproj -scheme TestGHUnit -sdk iphonesimulator  build
